...
3. 커밋 메시지 예: `deploy: v1.3-13 리브랜딩 + 아이 홈 대시보드 + 칭찬 우체통`
...
```
https://hyeong-ship-it.github.io/kids-mission-game/?v=1313
```

캐시 갱신이 안 되면 주소 끝에 `?v=1313` 을 추가하거나
